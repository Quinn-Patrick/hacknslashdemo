...
public class StateStandZombie : State
{
    public StateStandZombie(InputReader input, ILivingEntity self, ICharacterModel model) : base(input, self, model)
    {
    ...
    public override State InterpretInput()
    {
        ...
        {
            return new StateWalkingZombie(_input, _self, _model);
        }
