...
public class StateSprint : State
{
    public StateSprint(InputReader input, ILivingEntity self, ICharacterModel model) : base(input, self, model)
    {
        _state = StateNumber.Sprint;
    }
